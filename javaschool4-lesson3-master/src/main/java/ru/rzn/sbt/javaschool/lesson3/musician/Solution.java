...
class Vocalist extends Musician {
    ...
    public String sing() {
        ...
        switch (i) {
            case 0:
                result = "Take me to the magic of the moment";
                i = i + 1;
                break;
            case 1:
                result = "on a glory night";
                i = i + 1;
                break;
            case 2:
                result = "Where the children of tomorrow dream away";
                i = i + 1;
                break;
            case 3:
                result = "In the Wind of Change";
                i = 0;
                break;
...
class FrontMan extends Musician {
    private int i = 0;
    private int j = 0;
    ...
    public String sing() {
        ...
        switch (i) {
            case 0:
                result = "Take advantage while";
                i = i + 1;
                break;
            case 1:
                result = "You hang me out to dry";
                i = i + 1;
                break;
            case 2:
                result = "But I can't see you every night";
                i = i + 1;
                break;
            case 3:
                result = "Free I do";
